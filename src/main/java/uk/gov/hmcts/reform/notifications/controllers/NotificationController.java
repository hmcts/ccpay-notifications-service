...
public class NotificationController {
    ...
    public ResponseEntity emailNotification(
        ...
        return new ResponseEntity<>("Notification sent successfully via email", HttpStatus.CREATED);
    }
    ...
    public ResponseEntity letterNotification(
        ...
        return new ResponseEntity<>("Notification sent successfully via letter", HttpStatus.CREATED);
    }
